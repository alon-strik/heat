...
def api_put(method, params=None, data=None):
    'put to api_url in json encoded format'
    r = s.put(api_url + method, params=params, data=repr(data))
...
# Login
payload = {'username':'admin', 'secretkey':''}
...
#
# # Requests
# api_request('monitor/system/interface?interface_name=port2')
